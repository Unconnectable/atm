...
- **桌面版**（Tkinter）：采用简洁的功能按钮布局，主窗口尺寸 450×400，不可缩放。每个功能对应独立的 Frame，通过 switch_frame 统一切换。按钮使用色彩区分（绿色登录、蓝色提交、橙色修改密码）。
...
| 界面      | 桌面版                         | Web 版                                |
| --------- | ------------------------------ | ------------------------------------- |
| 登录      | 账号输入 + 密码输入 + 登录按钮 | 居中卡片，AETHER 品牌标识，毛玻璃效果 |
| 主菜单    | 5 个功能按钮竖向排列           | 2×2 网格 + 底部退出按钮，带图标       |
